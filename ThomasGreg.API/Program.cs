using ThomasGreg.API.DependencyMap;
...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "ThomasGreg API", Description = "", Version = "v1" });
    c.TagActionsBy(api =>
    {
...
builder.Services.AddMediatR(AppDomain.CurrentDomain.Load("ThomasGreg.Application"), AppDomain.CurrentDomain.Load("ThomasGreg.Core"));
...
if (builder.Environment.IsDevelopment())
{
    ...
    using (var scope = app.Services.CreateScope())
    {
        ...
        InicializadorBancoDados.Inicializar(dbContext);
    }
}
